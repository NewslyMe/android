package com.guichaguri.trackplayer.SeekBar;
import static com.guichaguri.trackplayer.SeekBar.BubbleUtils.dp2px;
import static com.guichaguri.trackplayer.SeekBar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        isHideBubble = a.getBoolean(R.styleable.BubbleSeekBar_bsb_hide_bubble, true);
